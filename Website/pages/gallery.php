...
body{
    ...
    <!-- ***** Header Area End ***** -->
        ...
        <main class="main minh-100vh">
            <!-- Section -->
            <section class="py-0 overflow-hidden text-center" id="top">
                <div class="bg-container overlay parallax" data-rellax-percentage="0.5" id="galleryheader"></div>
                <div class="container">
                    <div class="row h-100vh align-items-center">
                        <div class="col" style="margin-top: 500px;">
                            <h1 class="text-white text-uppercase fs-4 fs-lg-6" data-aos="fade-right" data-aos-duration="1000">Gallery</h1>
                        ...
                        <div class="col-lg-2 order-lg-1">
                            <div class="pb-6 py-lg-9" data-toggle="sticky">
                                ...
                                <ul class="mb-6 list-unstyled text-600">
                                    <a href="javascript:;" data-filter="*" class="text-600"><li class="mb-1 side">All</li></a>
                                    <a href="javascript:;" data-filter=".delhichalo" class="text-600"><li class="mb-1 side">Delhi Chalo</li></a>
                                     <a href="javascript:;" data-filter=".hazare" class="text-600"><li class="mb-1 side">Lokdal Haryana President with Anna Hazare</li></a>
                                     <a href="javascript:;" data-filter=".karkarta" class="text-600"><li class="mb-1 side">Karkarta Sambhelan</li></a>
                                    <a href="javascript:;" data-filter=".Jansabha" class="text-600"><li class="mb-1 side">Lokdal Jansabha</li></a>
                                    <a href="javascript:;" data-filter=".dharna" class="text-600"><li class="mb-1 side">Dharna Pradershan</li></a>
                                    <a href="javascript:;" data-filter=".t-20" class="text-600"><li class="mb-1 side">T-20 Championship</li></a>
                                    <a href="javascript:;" data-filter=".poster" class="text-600"><li class="mb-1 side">Posters</li></a>
                                    <a href="javascript:;" data-filter=".video" class="text-600"><li class="mb-1 side">Videos</li></a>
                                </ul>
                            ...
                            <div class="grid">
                                 <div class="row no-gutters mt-neg-3">
                                     ...
                                     <div class="col-md-6 col-lg-4 p-3 grid-item Jansabha karkarta">
                                         <a data-fancybox="gallery" href="../img/gallery/latest-gallery/gallery-1.jpeg"><img class="img-fluid w-100" src="../img/gallery/latest-gallery/gallery-1.jpeg" alt="Gallery Photo 01" /></a>
                                     </div>
                                     <div class="col-md-6 col-lg-4 p-3 grid-item Jansabha karkarta">
                                         <a data-fancybox="gallery" href="../img/gallery/latest-gallery/gallery-2.jpeg"><img class="img-fluid w-100" src="../img/gallery/latest-gallery/gallery-2.jpeg" alt="Gallery Photo 02" /></a>
                                     </div>
                                     <div class="col-md-6 col-lg-4 p-3 grid-item Jansabha karkarta">
                                         <a data-fancybox="gallery" href="../img/gallery/latest-gallery/gallery-3.jpeg"><img class="img-fluid w-100" src="../img/gallery/latest-gallery/gallery-3.jpeg" alt="Gallery Photo 03" /></a>
                                     </div>
                                     <div class="col-md-6 col-lg-4 p-3 grid-item Jansabha karkarta">
                                         <a data-fancybox="gallery" href="../img/gallery/latest-gallery/gallery-4.jpeg"><img class="img-fluid w-100" src="../img/gallery/latest-gallery/gallery-4.jpeg" alt="Gallery Photo 04" /></a>
                                     </div>
                                     <div class="col-md-6 col-lg-4 p-3 grid-item Jansabha karkarta">
                                         <a data-fancybox="gallery" href="../img/gallery/latest-gallery/gallery-5.jpeg"><img class="img-fluid w-100" src="../img/gallery/latest-gallery/gallery-5.jpeg" alt="Gallery Photo 05" /></a>
                                     </div>
                                     <div class="col-md-6 col-lg-4 p-3 grid-item Jansabha karkarta">
                                         <a data-fancybox="gallery" href="../img/gallery/latest-gallery/gallery-6.jpeg"><img class="img-fluid w-100" src="../img/gallery/latest-gallery/gallery-6.jpeg" alt="Gallery Photo 06" /></a>
                                     </div>
                                     <div class="col-md-6 col-lg-4 p-3 grid-item Jansabha karkarta">
                                         <a data-fancybox="gallery" href="../img/gallery/latest-gallery/gallery-7.jpeg"><img class="img-fluid w-100" src="../img/gallery/latest-gallery/gallery-7.jpeg" alt="Gallery Photo 07" /></a>
                                     </div>
                                     <div class="col-md-6 col-lg-4 p-3 grid-item Jansabha karkarta">
                                         <a data-fancybox="gallery" href="../img/gallery/latest-gallery/gallery-8.jpeg"><img class="img-fluid w-100" src="../img/gallery/latest-gallery/gallery-8.jpeg" alt="Gallery Photo 08" /></a>
                                     </div>
                                     <div class="col-md-6 col-lg-4 p-3 grid-item Jansabha karkarta">
