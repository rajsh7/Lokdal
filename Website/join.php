<?php
    ...
    if(isset($_POST["submit"])){
        ...
        $sql="INSERT INTO `members`(`name`, `email`, `contact`, `aadhar`, `address`) VALUES ('$name', '$email', '$contact', '$aadhar','$address');";

        if($con->query($sql)==true){
            //echo "successfully inserted";
            //echo $sql;
            
            echo "<script>alert('Welcome to Lokdal');</script>";
        }
        else{
...
<!-- ********** Hero Area Start ********** -->
    <div class="hero-area height-400 bg-img background-overlay" id="subheading"> 
        <h1 style="color: aliceblue; text-align: center; padding-top: 180px;">Join Lokdal</h1>
    </div>
    <!-- ********** Hero Area End ********** -->
