	...
	<body class="fixed-nav sticky-footer red-skin" id="page-top">
		...
		<div class="content-wrapper">
			...
			<div class="row page-titles">
				...
				<h4 class="theme-cl">Lokdal Members</h4>
                    <a href="add_member.php" id="submitbtn">Add More <strong>+</strong></a>
				</div>
			</div>
			<!-- Title & Breadcrumbs-->
				
				<!-- All Employee List Start --> 
				<div class="row">
						...
						<a href="#">
                            <div class="contact-box">
                                ...
                                <div class="contact-img">
                                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Circle-icons-profile.svg/768px-Circle-icons-profile.svg.png" class="img-circle img-responsive" alt="">
                                </div>
                                
                                <div class="contact-caption">
                                    <h4 class="font-16 font-midium"><strong>Name : </strong><?= $row['name'];?></h4>
                                    <h5><strong>Father's Name : </strong><?= $row['f_name'];?></h5>
                                    <h5><strong>Contact Number : </strong><?= $row['mobile'];?></h5>
									<h5><strong>State : </strong><?= $row['state'];?></h5>
									<h5><strong>District : </strong><?= $row['region'];?></h5>
                                    <h5><strong>Village : </strong><?= $row['village'];?></h5>
                                    <h5><strong>Block : </strong><?= $row['block'];?></h5>
                                    <h5><strong>Address : </strong><?= $row['address'];?></h5>
                                </div>
                                <div class="contact-action">
								<a href="update_member.php?update_id=<?= $row['id'];?>" class="bg-default br-default btn-circle-40" data-toggle="tooltip" title="Edit">
									<i class="light-cl fa fa-pencil" aria-hidden="true"></i>
								</a>
								<a href="delete_executive.php?delete_id=<?= $row['id'];?>" class="bg-success br-success btn-circle-40" data-toggle="tooltip" title="Delete">
