		...
		<div class="content-wrapper">
			...
			<div class="row page-titles">
				<div class="col-md-12 align-self-center">
					<h4 class="theme-cl">Daily Updates -> Manage Daily Updates</h4>
                    <a href="add_updates.php" id="submitbtn">Add More <strong>+</strong></a>
				</div>
			</div>
			<!-- Title & Breadcrumbs-->
                ...
                ?>
					...
					<div class="col-md-4 col-sm-6">
						<div class="our-team">
							<div class="pic">
								<img src="<?= $row['img'];?>" alt="our-team">
							</div>
							<div class="description">
								<div class="team-prof">
									<h4>Title : <?= $row['title'];?></h4>
									<span class="theme-cl">Description : <?= $row['description'];?></span>
                                    <span><?= $row['date'];?></span>
								</div>
								 <ul class="social-links">
									<li><a href="modify_updates.php?modify_id=<?= $row['id'];?>" class="fa fa-edit"></a></li>
									<li><a href="delete_update.php?delete_id=<?= $row['id'];?>" class="fa fa-trash-o"></a></li>
								</ul> 
							</div>
						</div>
					</div>
