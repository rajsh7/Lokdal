...
<?php
            if(isset($_GET['modify_id'])){
                ...
                $sql="SELECT * FROM daily_update where id=$modify_id;";
		...
		<div class="container-fluid">
			...
			<div class="row page-titles">
				<div class="col-md-12 align-self-center">
                    ...
                    <a href="delete_update.php?delete_id=<?= $rows['id'];?>" id="submitbtn">Delete Post</a>
                    <a href="manage_updates.php" id="submitbtn">Cancel</a>
				</div>
			</div>
			<!-- Title & Breadcrumbs-->
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
				<div class="card">
					...
					<div class="card-body">
						<form action="upload.php?update_id=<?= $rows['id'];?>" id="form" method="POST" enctype="multipart/form-data" class="dropzone dz-clickable success-dropzone">
							<div class="dz-default dz-message" style="text-align:center;">
								<h4>Upload Poster :-</h4>
								<div class="left">
                                    <img id="img" src="<?php echo $rows['img']; ?>"  style="height:400px; padding:8px; margin-bottom:10px;  border: Solid 5px; border-image: linear-gradient(#00772D, #4d9f0c) 30;"  alt="">
							...
							<div class="card-header col-md-12">
								...
								<input type="text" id="demo" class="col-md-4" name="title"  value="<?= $rows['title']; ?>" required>
								<h4 class="header-title m-t-0" style="margin-right:5px; margin-top:5px; margin-left:100px;">Post Description : </h4>
								<input type="text" class="col-md-4" name="description" value="<?= $rows['description']; ?>" required>
							</div>
						</form>
					</div>
