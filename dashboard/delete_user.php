<?php 
    ...
    if(isset($_SESSION['user'])){
        ...
        if(isset($_GET['delete'])){
            $del=$_GET['delete'];
            include_once("db.php");
            $sql="DELETE FROM `users` WHERE user='$del';";
        ...
        if(isset($_GET['delete_user'])){
            ...
            //echo "<script>alert('Are you sure, you want to Delete User : $user');</script>";
			...
			<div class="container-fluid">
				...
				<div class="row page-titles">
					<div class="col-md-12 align-self-center">
						<h4 class="theme-cl">Delete User : <?=$user?></h4>
					</div>
				</div>
				<!-- Title & Breadcrumbs-->
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card">
                            <br>
                            <h2 style="text-align:center;">Are you Sure to Delete the User : <?=$user?></h2><br><br>
							<div>
                                <a href="delete_user.php?delete=<?=$user?>" style="float:left; margin-left:40%" id="submitbtn">Yes, Delete It</a>
                                <a href="manage_user.php" style="float:right; margin-right:40%" id="submitbtn">No, Leave It</a>
