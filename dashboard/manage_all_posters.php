...
if(isset($_SESSION['user'])){
    ...
    if(isset($_GET['delete_id'])){
        $del=$_GET['delete_id'];
        $sqldel="DELETE FROM `leader_updates` WHERE id='$del';";
        $delete = mysqli_query($con,$sqldel);
    }
		...
		<div class="content-wrapper">
			...
			<div class="row page-titles">
				<div class="col-md-12 align-self-center">
					<h4 class="theme-cl">Leaders Daily Updates -> Manage All Posters</h4>
                    <a href="add_leader_update.php" id="submitbtn">Add More <strong>+</strong></a>
				</div>
			</div>
			<!-- Title & Breadcrumbs-->
						...
						<div class="our-team">
							...
							<div class="description">
								 ...
								 <ul class="social-links">
									<li><a href="manage_all_posters.php?delete_id=<?= $row['id'];?>" class="fa fa-trash-o"></a></li>
								</ul> 
							</div>
						</div>
					</div>
