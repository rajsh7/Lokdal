	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			<div class="row page-titles">
				...
				<h4 class="theme-cl">Recent Activities -> Manage Recent Activity</h4>
                    <a href="new_act.php" id="submitbtn">Add More <strong>+</strong></a>
				</div>
			</div>
			<!-- Title & Breadcrumbs-->
						...
						<div class="blox_instagram_quatro">
							<div class="padd-15 blox_instagram_quatro_container">
								...
								<div class="blox_instagram_info">
									<div class="blox_profile_name"><?= $row['title'];?></div>
									<div class="blox_follow_count"><?= $row['date'];?></div>
									<div class="blox_follow_btn">
										<a class="btn outline-secondary width-100" href="update_act.php?update_id=<?= $row['id'];?>">Manage</a>
										<a class="btn outline-secondary width-100" href="delete_act.php?delete_id=<?= $row['id'];?>">Delete</a>
									</div>
								</div>
							</div>
						</div>
